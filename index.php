...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="3"> Computer Technolody II Year ( Semester III )</option>
            <option value="4"> Computer Technolody II Year ( Semester IV )</option>
            <option value="5"> Computer Technolody III Year ( Semester V )</option>
            <option value="6"> Computer Technolody III Year ( Semester VI )</option>
            <option value="7"> Computer Technolody IV Year ( Semester VII )</option>
            <option value="8"> Computer Technolody IV Year ( Semester VIII )</option>
        </select>
