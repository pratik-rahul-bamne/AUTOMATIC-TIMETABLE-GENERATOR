...
<head>
    ...
    <title>TimeTable Management System, AITRC</title>
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        echo "AITRC " . $_POST['select_semester'] . " ";
            ...
            <tr>
                ...
                <td style="text-align:center">9.30 am to 10:30 am </td>
                <td style="text-align:center">10:30 am to 11:30 am</td>
                <td style="text-align:center">11:30 am to 12:15 pm</td>
                <td style="text-align:center">12:15 pm to 1:15 pm</td>
                <td style="text-align:center">1:15 pm to 2:15 pm</td>
                <td style="text-align:center">2:15 pm to 2:30 pm</td>
                <td style="text-align:center">2:30 pm to 3:30 pm</td>
                <td style="text-align:center">3:30 pm to 4:30 pm</td>
            </tr>
            <?php
                $table = null;
                if (isset($_POST['select_semester'])) {
                    ...
                    if (isset($_POST['select_semester'])) {
                        while ($r = mysqli_fetch_assoc($qq)) {
                            if ($r['isAlloted'] == 1 && $r['semester'] == $_POST['select_semester']) {
                                $str .= $r['subject_name'] . ": " . $r['subject_name'] . ", ";
                        ...
                        while ($r = mysqli_fetch_assoc($qq)) {
                            if ($r['isAlloted'] == 1 && $r['allotedto'] == $tid) {
                                $str .= $r['subject_name'] . ": " . $r['subject_name'] . " <br>";
                ...
                <td style=\"text-align:center\">LONG RECESS</td>
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                 <td style=\"text-align:center\">SHORT RECESS</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TimeTable Management System, AITRC.";
