...
// Fetch subject name from the subjects table
$query = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"), "SELECT * FROM subjects WHERE subject_code = '$sub'");
$row = mysqli_fetch_assoc($query);
